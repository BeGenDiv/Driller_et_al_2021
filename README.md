This repository contains scripts used in **Optimization of ddRAD-like data leads to high quality sets of reduced representation single copy orthologs (R2SCOs) in a sea turtle multi-species analysis.** by Driller et al.. A pre-print version can be found on [bioRxive](https://www.biorxiv.org/content/10.1101/2020.04.03.024331v1).
